//
//  Bildschneider_PolygonCropView.m
//  Bildschneider
//
...
@interface Bildschneider_PolygonCropView() {
     CGPoint lastPoint;
}
...
@implementation Bildschneider_PolygonCropView
...
- (UIImage *)deleteBackgroundOfImage:(UIImageView *)image
{
    ...
    
    {
        ...
        CGPoint p1 = [Bildschneider_PolygonCropView convertCGPoint:[[points objectAtIndex:0] CGPointValue] fromRect1:image.frame.size toRect2:image.image.size];
        [aPath moveToPoint:CGPointMake(p1.x, p1.y)];
        
        for (uint i=1; i<points.count; i++)
        {
            CGPoint p = [Bildschneider_PolygonCropView convertCGPoint:[[points objectAtIndex:i] CGPointValue] fromRect1:image.frame.size toRect2:image.image.size];
